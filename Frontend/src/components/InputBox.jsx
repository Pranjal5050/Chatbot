...
//         {/* Image Upload */}
//         <label className="cursor-pointer bg-gray-700 px-3 py-2 rounded-lg">
//           📎
//           <input
//             type="file"
//             accept="image/*"
...
//           onChange={(e) => setInput(e.target.value)}
//           placeholder="Ask anything..."
//           className="flex-1 bg-[#020617] border border-gray-700 p-3 rounded-lg text-white "
//         />

//         {/* Voice Button */}
//         <button
//           onClick={() => startVoiceInput(setInput)}
//           className="bg-gray-700 px-4 py-2 rounded-lg cursor-pointer"
//         >
//           🎤
//         </button>
...
//         <button
//           onClick={sendMessage}
//           className="bg-black px-6 py-2 rounded-lg cursor-pointer"
//         >
//           Send
//         </button>
...
const InputBox = () => {
  ...
  return (
    ...
    // <div className="p-3 md:p-4 border-t border-gray-700 bg-[#0f172a]">
    <div className="fixed bottom-3 left-0 right-0 bg-[#0f172a] p-1 md:p-4 z-40">
